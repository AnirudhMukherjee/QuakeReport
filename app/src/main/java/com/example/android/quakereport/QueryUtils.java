...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            String s2,s3;
            JSONObject json1 = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray jarray1 = json1.getJSONArray("features");
            for(int i = 0;i<jarray1.length();i++){
                JSONObject json2 = jarray1.getJSONObject(i);
                JSONObject json3 = json2.getJSONObject("properties");
                double magnitude = json3.getDouble("mag");
                s2=json3.getString("place");
                long time = json3.getLong("time");
                earthquakes.add(new Earthquake(magnitude,s2,time));
